...
QueueHandle_t Dinosour_Queue_Handle = 0;
QueueHandle_t Cact_Queue_Handle = 0;
QueueHandle_t CactCurrent_Queue_Handle = 0;
QueueHandle_t Egg_Queue_Handle = 0;
...
void setup() {
  ...
  Dinosour_Queue_Handle = xQueueCreate(3, sizeof(int));
  Cact_Queue_Handle = xQueueCreate(3, sizeof(int));
  CactCurrent_Queue_Handle = xQueueCreate(3, sizeof(int));
  Egg_Queue_Handle = xQueueCreate(9, sizeof(int));
